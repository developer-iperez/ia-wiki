...
- [[claude/fundamentos/claude-code|Claude Code]] — uno de los agentes con los que se integra vía hook.
- [[claude/extension/hooks|Hooks de Claude Code]] — el mecanismo concreto que usa `rtk init -g` para reescribir los comandos de forma transparente.
- [[claude/fundamentos/comandos|Comandos útiles de Claude Code]] — comandos como `/cost` para medir consumo; `rtk` lo reduce de forma proactiva.
